...
function ObjednavkaB2BDetail() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get(`${process.env.REACT_APP_API_URL}/get-tav-order-details/${orderId}`);
...
export default ObjednavkaB2BDetail;
